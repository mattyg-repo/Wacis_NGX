...
<head>
    ...
    <link href="<?=THEME_ASSETS?>font-awesome/css/font-awesome.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <!-- Mainly scripts -->
    <script src="<?=THEME_ASSETS?>js/jquery-3.1.1.min.js"></script>
    <script src="<?=THEME_ASSETS?>js/popper.min.js"></script>
    <script src="<?=THEME_ASSETS?>js/bootstrap.js"></script>
