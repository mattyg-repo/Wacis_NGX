...
/*
    ...
    <div class="c-sidebar c-sidebar-lg c-sidebar-light c-sidebar-right c-sidebar-overlaid" id="aside">
        <button class="c-sidebar-close c-class-toggler" type="button" data-target="_parent" data-class="c-sidebar-show"
            responsive="true">
            <svg class="c-icon">
                <use xlink:href="<?=THEME_ASSETS?>vendors/@coreui/icons/svg/free.svg#cil-x"></use>
</svg>
</button>
<ul class="nav nav-tabs nav-underline nav-underline-primary" role="tablist">
    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">
            <svg class="c-icon">
                <use xlink:href="<?=THEME_ASSETS?>vendors/@coreui/icons/svg/free.svg#cil-list"></use>
            </svg></a></li>
        ...
        <div class="list-group list-group-accent">
            ...
            <div class="list-group-item list-group-item-accent-warning list-group-item-divider">
                ...
                <div>Meeting with <strong>Lucas</strong></div><small class="text-muted mr-3">
                    <svg class="c-icon">
                        <use xlink:href="<?=THEME_ASSETS?>vendors/@coreui/icons/svg/free.svg#cil-calendar">
                        </use>
                    </svg>&nbsp; 1 - 3pm</small><small class="text-muted">
                    <svg class="c-icon">
                        <use xlink:href="<?=THEME_ASSETS?>vendors/@coreui/icons/svg/free.svg#cil-location-pin">
                        </use>
            ...
            <div class="list-group-item list-group-item-accent-info">
                ...
                <div>Skype with <strong>Megan</strong></div><small class="text-muted mr-3">
                    ...
                    <svg class="c-icon">
                        <use xlink:href="<?=THEME_ASSETS?>vendors/@coreui/icons/svg/brand.svg#cib-skype"></use>
                    </svg>&nbsp; On-line</small>
            </div>
            <div
                class="list-group-item list-group-item-accent-secondary bg-light text-center font-weight-bold text-muted text-uppercase c-small">
            ...
            <div class="list-group-item list-group-item-accent-danger list-group-item-divider">
                <div>New UI Project - <strong>deadline</strong></div><small class="text-muted mr-3">
                    ...
                    <svg class="c-icon">
                        <use xlink:href="<?=THEME_ASSETS?>vendors/@coreui/icons/svg/free.svg#cil-home"></use>
    ...
    <div class="tab-pane p-3" id="messages" role="tabpanel">
        <div class="message">
            ...
            <div><small class="text-muted">Lukasz Holeczek</small><small class="text-muted float-right mt-1">1:52
                    PM</small></div>
            <div class="text-truncate font-weight-bold">Lorem ipsum dolor sit amet</div><small class="text-muted">Lorem
